...
namespace CBFrontend.UI.Logistics
{
	public partial class List : SessionChild
	{
		...
		private readonly IGetPaginatedEncryptableRequest<IEventfulLogisticsService.GetLogisticsOrdersParameter> request = new GetPaginatedEncryptableRequest<IEventfulLogisticsService.GetLogisticsOrdersParameter>() { PerPage = 100, Parameter= new ILogisticsService.GetLogisticsOrdersParameter() };
